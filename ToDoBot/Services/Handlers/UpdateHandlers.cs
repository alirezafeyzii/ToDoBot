    ...
    public class UpdateHandlers
    {
        ...
        private async Task BotOnMessageReceived(Message message, CancellationToken cancellationToken)
        {
            ...
            var action = messageText.Split(' ')[0] switch
            {
                ...
                "/set" => StartInlineQuery(_botClient, message, cancellationToken),
            ...
            async Task<Message> Set(ITelegramBotClient telegramBotClient, Message message, CancellationToken cancellationToken)
            {

               // var jobId = _backgroundJobClient.Schedule(() => a(), DateTime.Now);
                ...
                void gg()
                {
                   var a =  telegramBotClient.SendTextMessageAsync(
                   chatId: message.Chat.Id,
                   text: "Press the button to start query").Result;
                }
            }
        }
